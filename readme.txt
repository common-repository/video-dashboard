...
Tags: YouTube, Dashboard, Admin, Vimeo, Video
...
For more info, please [visit our site](https://pagecrafter.com/embed-videos-in-dashboard-plugin/).
...
1. The plugin in action. Videos are embedded directly into the dashboard screen.
2. The admin screen for Video Dashboard. Options include the ability to select the number of videos that will be displayed and which roles will have the ability to see the videos in the dashboard.
